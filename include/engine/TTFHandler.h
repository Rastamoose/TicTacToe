...
class TTFHandler{
    ...
    void loadTextCentered(const std::string& name, const std::string& fontName, const std::string& text, const Colour& colour, uint32_t lineLength);     // lineLength in px
    ...
    void loadTextWrappedCentered(const std::string& name, const std::string& fontName, const char* text, const Colour& colour, uint32_t wrapLength=0);
    void delText(const std::string& name);                      // delete texture from map
    SDL_Texture* getText(const std::string& name);
    Point getTextSize(const std::string& name);
};
